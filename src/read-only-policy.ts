...
export const READ_ONLY_OPERATIONS = {
  ...
  ncloud_list_acg_rules: {
    ...
    title: "List Ncloud ACG rules",
    description: "Read-only: list inbound/outbound rules for one NAVER Cloud access control group.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vserver/v2/getAccessControlGroupRuleList",
    ncloudAction: "getAccessControlGroupRuleList",
  },
  ncloud_list_network_interfaces: {
    toolName: "ncloud_list_network_interfaces",
    title: "List Ncloud network interfaces",
    description: "Read-only: list NAVER Cloud VPC network interfaces (incl. attached ACGs and server).",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vserver/v2/getNetworkInterfaceList",
    ncloudAction: "getNetworkInterfaceList",
  },
  ncloud_get_network_interface: {
    toolName: "ncloud_get_network_interface",
    title: "Get Ncloud network interface detail",
    description: "Read-only: get details for one NAVER Cloud VPC network interface.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vserver/v2/getNetworkInterfaceDetail",
    ncloudAction: "getNetworkInterfaceDetail",
  },
  ncloud_list_network_acls: {
    toolName: "ncloud_list_network_acls",
    title: "List Ncloud network ACLs",
    description: "Read-only: list NAVER Cloud VPC network ACLs.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getNetworkAclList",
    ncloudAction: "getNetworkAclList",
  },
  ncloud_list_network_acl_rules: {
    toolName: "ncloud_list_network_acl_rules",
    title: "List Ncloud network ACL rules",
    description: "Read-only: list inbound/outbound rules for one NAVER Cloud VPC network ACL.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getNetworkAclRuleList",
    ncloudAction: "getNetworkAclRuleList",
  },
  ncloud_list_public_ips: {
    toolName: "ncloud_list_public_ips",
    title: "List Ncloud public IPs",
    description: "Read-only: list NAVER Cloud VPC public IP instances.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vserver/v2/getPublicIpInstanceList",
    ncloudAction: "getPublicIpInstanceList",
  },
  ncloud_list_route_tables: {
    toolName: "ncloud_list_route_tables",
    title: "List Ncloud route tables",
    description: "Read-only: list NAVER Cloud VPC route tables.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getRouteTableList",
    ncloudAction: "getRouteTableList",
  },
  ncloud_list_routes: {
    toolName: "ncloud_list_routes",
    title: "List Ncloud routes",
    description: "Read-only: list routes in one NAVER Cloud VPC route table.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getRouteList",
    ncloudAction: "getRouteList",
  },
  ncloud_list_route_table_subnets: {
    toolName: "ncloud_list_route_table_subnets",
    title: "List Ncloud route table subnets",
    description: "Read-only: list subnets associated with one NAVER Cloud VPC route table.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getRouteTableSubnetList",
    ncloudAction: "getRouteTableSubnetList",
  },
  ncloud_list_nat_gateways: {
    toolName: "ncloud_list_nat_gateways",
    title: "List Ncloud NAT gateways",
    description: "Read-only: list NAVER Cloud VPC NAT gateway instances.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getNatGatewayInstanceList",
    ncloudAction: "getNatGatewayInstanceList",
  },
  ncloud_list_vpc_peerings: {
    toolName: "ncloud_list_vpc_peerings",
    title: "List Ncloud VPC peerings",
    description: "Read-only: list NAVER Cloud VPC peering instances.",
    service: "ncloud",
    method: "GET",
    pathTemplate: "/vpc/v2/getVpcPeeringInstanceList",
    ncloudAction: "getVpcPeeringInstanceList",
  },
